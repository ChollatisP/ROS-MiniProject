...
sub_poten = rospy.Subscriber("Topic_Feedback_poten", Int16, callback = read)
pub_encode = rospy.Publisher("Topic_Input_encode", Int16, queue_size = 10)
sub_encode = rospy.Subscriber("Topic_Feedback_encode", Int16, callback = read)
pub_encode = rospy.Publisher("joint_state", Int16, queue_size = 10)'''
